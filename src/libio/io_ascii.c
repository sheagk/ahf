 ...
 */
inline static io_ascii_t local_openopen(io_logging_t log, io_ascii_t f,
                                        io_file_mode_t mode);
...
extern uint64_t io_ascii_readpart(io_logging_t log, io_ascii_t f,
    ...
    for (i = 0; i < pread; i++) {
        ...
        \**************************************************/
        if (f->header->multi_mass == 1) {
            if (sscanf(buffer, "%lf %lf %lf %lf %lf %lf %lf %lf", &fposx,
                       &fposy, &fposz, &fmomx, &fmomy, &fmomz, &fweight,
                       &fu) == 7) {
                fu = -1;
            }
            //      fprintf(stderr,"%"PRIu64" %lf %lf %lf  %lf %lf %lf  %lf
            //      %lf\n",
            ...
            sscanf(buffer, "%lf %lf %lf %lf %lf %lf", &fposx, &fposy, &fposz,
                   &fmomx, &fmomy, &fmomz);
            fweight = 1.;
        }
