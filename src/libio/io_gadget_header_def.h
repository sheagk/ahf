...
#define GADGET_HEADER_HEADERSIZE                                               \
    (13 * sizeof(int32_t) + 12 * sizeof(uint32_t) + 12 * sizeof(double))

/** Defines the number of unused bytes in the header */
#define GADGET_HEADER_FILLHEADER (GADGET_HEADER_SIZE - GADGET_HEADER_HEADERSIZE)
