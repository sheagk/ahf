...
/* $Id: io_gadget_def.h,v 1.8 2007/11/01 09:23:49 knolli Exp $ */

/**
 * \file io_gadget_def.h
 *
 * Provides the structure definition for the Gadget file structure.
 */
